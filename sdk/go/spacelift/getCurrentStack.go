...
//			this, err := spacelift.GetCurrentStack(ctx, map[string]interface{}{}, nil)
//			if err != nil {
//				return err
//			}
//			_, err = spacelift.NewEnvironmentVariable(ctx, "core-kubeconfig", &spacelift.EnvironmentVariableArgs{
//				StackId: pulumi.String(pulumi.String(this.Id)),
...
func GetCurrentStackOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetCurrentStackResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetCurrentStackResultOutput, error) {
		options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
		return ctx.InvokeOutput("spacelift:index/getCurrentStack:getCurrentStack", nil, GetCurrentStackResultOutput{}, options).(GetCurrentStackResultOutput), nil
