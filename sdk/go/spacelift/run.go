...
//			this, err := spacelift.NewStack(ctx, "this", &spacelift.StackArgs{
//				Name:       pulumi.String("Test stack"),
...
//				return err
//			}
//			_, err = spacelift.NewRun(ctx, "this", &spacelift.RunArgs{
//				StackId: this.ID(),
...
// Arbitrary map of values that, when changed, will trigger recreation of the resource.
func (o RunOutput) Keepers() pulumi.StringMapOutput {
	return o.ApplyT(func(v *Run) pulumi.StringMapOutput { return v.Keepers }).(pulumi.StringMapOutput)
}
