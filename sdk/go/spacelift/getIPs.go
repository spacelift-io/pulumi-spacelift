...
//			_, err := spacelift.GetIPs(ctx, map[string]interface{}{}, nil)
//			if err != nil {
//				return err
//			}
//			return nil
...
func GetIPsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetIPsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetIPsResultOutput, error) {
		...
		return ctx.InvokeOutput("spacelift:index/getIPs:getIPs", nil, GetIPsResultOutput{}, options).(GetIPsResultOutput), nil
	}).(GetIPsResultOutput)
}
