...
//			_, err := spacelift.GetVcsAgentPools(ctx, map[string]interface{}{}, nil)
//			if err != nil {
//				return err
//			}
//			return nil
...
func GetVcsAgentPoolsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetVcsAgentPoolsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetVcsAgentPoolsResultOutput, error) {
		options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
		return ctx.InvokeOutput("spacelift:index/getVcsAgentPools:getVcsAgentPools", nil, GetVcsAgentPoolsResultOutput{}, options).(GetVcsAgentPoolsResultOutput), nil
