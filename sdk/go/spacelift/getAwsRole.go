...
func LookupAwsRoleOutput(ctx *pulumi.Context, args LookupAwsRoleOutputArgs, opts ...pulumi.InvokeOption) LookupAwsRoleResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupAwsRoleResultOutput, error) {
			args := v.(LookupAwsRoleArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("spacelift:index/getAwsRole:getAwsRole", args, LookupAwsRoleResultOutput{}, options).(LookupAwsRoleResultOutput), nil
