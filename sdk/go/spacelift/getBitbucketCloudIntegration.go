...
//			_, err := spacelift.GetBitbucketCloudIntegration(ctx, &spacelift.GetBitbucketCloudIntegrationArgs{}, nil)
//			if err != nil {
//				return err
//			}
//			return nil
...
func GetBitbucketCloudIntegrationOutput(ctx *pulumi.Context, args GetBitbucketCloudIntegrationOutputArgs, opts ...pulumi.InvokeOption) GetBitbucketCloudIntegrationResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetBitbucketCloudIntegrationResultOutput, error) {
			args := v.(GetBitbucketCloudIntegrationArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("spacelift:index/getBitbucketCloudIntegration:getBitbucketCloudIntegration", args, GetBitbucketCloudIntegrationResultOutput{}, options).(GetBitbucketCloudIntegrationResultOutput), nil
