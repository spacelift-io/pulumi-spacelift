...
// StackPulumiConfigInput is an input type that accepts StackPulumiConfigArgs and StackPulumiConfigOutput values.
// You can construct a concrete instance of `StackPulumiConfigInput` via:
//
//	StackPulumiConfigArgs{...}
type StackPulumiConfigInput interface {
	pulumi.Input

	ToStackPulumiConfigOutput() StackPulumiConfigOutput
	ToStackPulumiConfigOutputWithContext(context.Context) StackPulumiConfigOutput
}

type StackPulumiConfigArgs struct {
	// State backend to log into on Run initialize.
...
func (StackPulumiConfigArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*StackPulumiConfig)(nil)).Elem()
}

func (i StackPulumiConfigArgs) ToStackPulumiConfigOutput() StackPulumiConfigOutput {
	return i.ToStackPulumiConfigOutputWithContext(context.Background())
}

func (i StackPulumiConfigArgs) ToStackPulumiConfigOutputWithContext(ctx context.Context) StackPulumiConfigOutput {
	return pulumi.ToOutputWithContext(ctx, i).(StackPulumiConfigOutput)
}

func (i StackPulumiConfigArgs) ToStackPulumiConfigPtrOutput() StackPulumiConfigPtrOutput {
	return i.ToStackPulumiConfigPtrOutputWithContext(context.Background())
}

func (i StackPulumiConfigArgs) ToStackPulumiConfigPtrOutputWithContext(ctx context.Context) StackPulumiConfigPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(StackPulumiConfigOutput).ToStackPulumiConfigPtrOutputWithContext(ctx)
}

// StackPulumiConfigPtrInput is an input type that accepts StackPulumiConfigArgs, StackPulumiConfigPtr and StackPulumiConfigPtrOutput values.
// You can construct a concrete instance of `StackPulumiConfigPtrInput` via:
//
//	        StackPulumiConfigArgs{...}
//
//	or:
//
//	        nil
type StackPulumiConfigPtrInput interface {
	pulumi.Input

	ToStackPulumiConfigPtrOutput() StackPulumiConfigPtrOutput
	ToStackPulumiConfigPtrOutputWithContext(context.Context) StackPulumiConfigPtrOutput
}

type stackPulumiConfigPtrType StackPulumiConfigArgs

func StackPulumiConfigPtr(v *StackPulumiConfigArgs) StackPulumiConfigPtrInput {
	return (*stackPulumiConfigPtrType)(v)
}

func (*stackPulumiConfigPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**StackPulumiConfig)(nil)).Elem()
}

func (i *stackPulumiConfigPtrType) ToStackPulumiConfigPtrOutput() StackPulumiConfigPtrOutput {
	return i.ToStackPulumiConfigPtrOutputWithContext(context.Background())
}

func (i *stackPulumiConfigPtrType) ToStackPulumiConfigPtrOutputWithContext(ctx context.Context) StackPulumiConfigPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(StackPulumiConfigPtrOutput)
}

type StackPulumiConfigOutput struct{ *pulumi.OutputState }

func (StackPulumiConfigOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*StackPulumiConfig)(nil)).Elem()
}

func (o StackPulumiConfigOutput) ToStackPulumiConfigOutput() StackPulumiConfigOutput {
	return o
}

func (o StackPulumiConfigOutput) ToStackPulumiConfigOutputWithContext(ctx context.Context) StackPulumiConfigOutput {
	return o
}

func (o StackPulumiConfigOutput) ToStackPulumiConfigPtrOutput() StackPulumiConfigPtrOutput {
	return o.ToStackPulumiConfigPtrOutputWithContext(context.Background())
}

func (o StackPulumiConfigOutput) ToStackPulumiConfigPtrOutputWithContext(ctx context.Context) StackPulumiConfigPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v StackPulumiConfig) *StackPulumiConfig {
		return &v
	}).(StackPulumiConfigPtrOutput)
}

// State backend to log into on Run initialize.
func (o StackPulumiConfigOutput) LoginUrl() pulumi.StringOutput {
	return o.ApplyT(func(v StackPulumiConfig) string { return v.LoginUrl }).(pulumi.StringOutput)
}

// Pulumi stack name to use with the state backend.
func (o StackPulumiConfigOutput) StackName() pulumi.StringOutput {
	return o.ApplyT(func(v StackPulumiConfig) string { return v.StackName }).(pulumi.StringOutput)
}

type StackPulumiConfigPtrOutput struct{ *pulumi.OutputState }

func (StackPulumiConfigPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**StackPulumiConfig)(nil)).Elem()
}

func (o StackPulumiConfigPtrOutput) ToStackPulumiConfigPtrOutput() StackPulumiConfigPtrOutput {
	return o
}

func (o StackPulumiConfigPtrOutput) ToStackPulumiConfigPtrOutputWithContext(ctx context.Context) StackPulumiConfigPtrOutput {
	return o
}

func (o StackPulumiConfigPtrOutput) Elem() StackPulumiConfigOutput {
	return o.ApplyT(func(v *StackPulumiConfig) StackPulumiConfig {
		if v != nil {
			return *v
		}
		var ret StackPulumiConfig
		return ret
	}).(StackPulumiConfigOutput)
}

// State backend to log into on Run initialize.
func (o StackPulumiConfigPtrOutput) LoginUrl() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *StackPulumiConfig) *string {
		if v == nil {
			return nil
		}
		return &v.LoginUrl
...
// Pulumi stack name to use with the state backend.
func (o StackPulumiConfigPtrOutput) StackName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *StackPulumiConfig) *string {
		if v == nil {
			return nil
		}
...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*StackPulumiConfigInput)(nil)).Elem(), StackPulumiConfigArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*StackPulumiConfigPtrInput)(nil)).Elem(), StackPulumiConfigArgs{})
	...
	pulumi.RegisterOutputType(StackPulumiConfigOutput{})
	pulumi.RegisterOutputType(StackPulumiConfigPtrOutput{})
