...
func LookupStackAwsRoleOutput(ctx *pulumi.Context, args LookupStackAwsRoleOutputArgs, opts ...pulumi.InvokeOption) LookupStackAwsRoleResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupStackAwsRoleResultOutput, error) {
			args := v.(LookupStackAwsRoleArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("spacelift:index/getStackAwsRole:getStackAwsRole", args, LookupStackAwsRoleResultOutput{}, options).(LookupStackAwsRoleResultOutput), nil
