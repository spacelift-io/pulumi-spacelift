...
type Stack struct {
	...
	PulumiConfig StackPulumiConfigPtrOutput `pulumi:"pulumiConfig"`
...
type stackState struct {
	...
	// Pulumi-specific configuration. Presence means this Stack is a Pulumi Stack.
	PulumiConfig *StackPulumiConfig `pulumi:"pulumiConfig"`
	// One-way VCS integration using a raw Git repository link
...
type StackState struct {
	...
	// Pulumi-specific configuration. Presence means this Stack is a Pulumi Stack.
	PulumiConfig StackPulumiConfigPtrInput
	// One-way VCS integration using a raw Git repository link
...
// Pulumi-specific configuration. Presence means this Stack is a Pulumi Stack.
func (o StackOutput) PulumiConfig() StackPulumiConfigPtrOutput {
	return o.ApplyT(func(v *Stack) StackPulumiConfigPtrOutput { return v.PulumiConfig }).(StackPulumiConfigPtrOutput)
}
