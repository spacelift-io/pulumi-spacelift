...
//			_, err := spacelift.GetGitlabWebhookEndpoint(ctx, map[string]interface{}{}, nil)
//			if err != nil {
//				return err
//			}
//			return nil
...
func GetGitlabWebhookEndpointOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetGitlabWebhookEndpointResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetGitlabWebhookEndpointResultOutput, error) {
		options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
		return ctx.InvokeOutput("spacelift:index/getGitlabWebhookEndpoint:getGitlabWebhookEndpoint", nil, GetGitlabWebhookEndpointResultOutput{}, options).(GetGitlabWebhookEndpointResultOutput), nil
