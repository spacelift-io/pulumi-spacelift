...
//			this, err := spacelift.GetSpaces(ctx, map[string]interface{}{}, nil)
//			if err != nil {
//				return err
//			}
...
func GetSpacesOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetSpacesResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetSpacesResultOutput, error) {
		options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
		return ctx.InvokeOutput("spacelift:index/getSpaces:getSpaces", nil, GetSpacesResultOutput{}, options).(GetSpacesResultOutput), nil
