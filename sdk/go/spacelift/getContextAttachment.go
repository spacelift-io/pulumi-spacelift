...
func LookupContextAttachmentOutput(ctx *pulumi.Context, args LookupContextAttachmentOutputArgs, opts ...pulumi.InvokeOption) LookupContextAttachmentResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupContextAttachmentResultOutput, error) {
			args := v.(LookupContextAttachmentArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("spacelift:index/getContextAttachment:getContextAttachment", args, LookupContextAttachmentResultOutput{}, options).(LookupContextAttachmentResultOutput), nil
