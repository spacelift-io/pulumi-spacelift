...
//			_, err := spacelift.GetGitlabIntegration(ctx, &spacelift.GetGitlabIntegrationArgs{}, nil)
//			if err != nil {
//				return err
//			}
//			return nil
...
func GetGitlabIntegrationOutput(ctx *pulumi.Context, args GetGitlabIntegrationOutputArgs, opts ...pulumi.InvokeOption) GetGitlabIntegrationResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetGitlabIntegrationResultOutput, error) {
			args := v.(GetGitlabIntegrationArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("spacelift:index/getGitlabIntegration:getGitlabIntegration", args, GetGitlabIntegrationResultOutput{}, options).(GetGitlabIntegrationResultOutput), nil
