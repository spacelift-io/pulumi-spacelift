...
func GetSpaceByPathOutput(ctx *pulumi.Context, args GetSpaceByPathOutputArgs, opts ...pulumi.InvokeOption) GetSpaceByPathResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetSpaceByPathResultOutput, error) {
			args := v.(GetSpaceByPathArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("spacelift:index/getSpaceByPath:getSpaceByPath", args, GetSpaceByPathResultOutput{}, options).(GetSpaceByPathResultOutput), nil
