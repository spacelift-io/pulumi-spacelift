...
//			_, err := spacelift.GetGithubEnterpriseIntegration(ctx, &spacelift.GetGithubEnterpriseIntegrationArgs{}, nil)
//			if err != nil {
//				return err
//			}
//			return nil
...
func GetGithubEnterpriseIntegrationOutput(ctx *pulumi.Context, args GetGithubEnterpriseIntegrationOutputArgs, opts ...pulumi.InvokeOption) GetGithubEnterpriseIntegrationResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetGithubEnterpriseIntegrationResultOutput, error) {
			args := v.(GetGithubEnterpriseIntegrationArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("spacelift:index/getGithubEnterpriseIntegration:getGithubEnterpriseIntegration", args, GetGithubEnterpriseIntegrationResultOutput{}, options).(GetGithubEnterpriseIntegrationResultOutput), nil
