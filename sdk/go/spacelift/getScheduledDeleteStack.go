...
func GetScheduledDeleteStackOutput(ctx *pulumi.Context, args GetScheduledDeleteStackOutputArgs, opts ...pulumi.InvokeOption) GetScheduledDeleteStackResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetScheduledDeleteStackResultOutput, error) {
			args := v.(GetScheduledDeleteStackArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("spacelift:index/getScheduledDeleteStack:getScheduledDeleteStack", args, GetScheduledDeleteStackResultOutput{}, options).(GetScheduledDeleteStackResultOutput), nil
