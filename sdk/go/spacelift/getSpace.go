...
//				SpaceId: spaceSpaceliftSpace.Id,
//			}, nil)
//			if err != nil {
//				return err
//			}
...
func LookupSpaceOutput(ctx *pulumi.Context, args LookupSpaceOutputArgs, opts ...pulumi.InvokeOption) LookupSpaceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSpaceResultOutput, error) {
			...
			return ctx.InvokeOutput("spacelift:index/getSpace:getSpace", args, LookupSpaceResultOutput{}, options).(LookupSpaceResultOutput), nil
