...
func LookupVcsAgentPoolOutput(ctx *pulumi.Context, args LookupVcsAgentPoolOutputArgs, opts ...pulumi.InvokeOption) LookupVcsAgentPoolResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupVcsAgentPoolResultOutput, error) {
			args := v.(LookupVcsAgentPoolArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("spacelift:index/getVcsAgentPool:getVcsAgentPool", args, LookupVcsAgentPoolResultOutput{}, options).(LookupVcsAgentPoolResultOutput), nil
