...
//			_, err := spacelift.GetAzureDevopsIntegration(ctx, &spacelift.GetAzureDevopsIntegrationArgs{}, nil)
//			if err != nil {
//				return err
//			}
//			return nil
...
func GetAzureDevopsIntegrationOutput(ctx *pulumi.Context, args GetAzureDevopsIntegrationOutputArgs, opts ...pulumi.InvokeOption) GetAzureDevopsIntegrationResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetAzureDevopsIntegrationResultOutput, error) {
			args := v.(GetAzureDevopsIntegrationArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("spacelift:index/getAzureDevopsIntegration:getAzureDevopsIntegration", args, GetAzureDevopsIntegrationResultOutput{}, options).(GetAzureDevopsIntegrationResultOutput), nil
