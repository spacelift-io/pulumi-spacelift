...
func GetContextsOutput(ctx *pulumi.Context, args GetContextsOutputArgs, opts ...pulumi.InvokeOption) GetContextsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetContextsResultOutput, error) {
			args := v.(GetContextsArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("spacelift:index/getContexts:getContexts", args, GetContextsResultOutput{}, options).(GetContextsResultOutput), nil
