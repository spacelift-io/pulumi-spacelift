...
//			_, err := spacelift.GetWorkerPools(ctx, map[string]interface{}{}, nil)
//			if err != nil {
//				return err
//			}
//			return nil
...
func GetWorkerPoolsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetWorkerPoolsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetWorkerPoolsResultOutput, error) {
		options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
		return ctx.InvokeOutput("spacelift:index/getWorkerPools:getWorkerPools", nil, GetWorkerPoolsResultOutput{}, options).(GetWorkerPoolsResultOutput), nil
