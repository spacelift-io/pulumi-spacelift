...
func LookupAwsIntegrationOutput(ctx *pulumi.Context, args LookupAwsIntegrationOutputArgs, opts ...pulumi.InvokeOption) LookupAwsIntegrationResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupAwsIntegrationResultOutput, error) {
			args := v.(LookupAwsIntegrationArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("spacelift:index/getAwsIntegration:getAwsIntegration", args, LookupAwsIntegrationResultOutput{}, options).(LookupAwsIntegrationResultOutput), nil
