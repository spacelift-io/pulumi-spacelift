...
//			_, err := spacelift.GetAccount(ctx, map[string]interface{}{}, nil)
//			if err != nil {
//				return err
//			}
//			return nil
...
func GetAccountOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetAccountResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetAccountResultOutput, error) {
		...
		return ctx.InvokeOutput("spacelift:index/getAccount:getAccount", nil, GetAccountResultOutput{}, options).(GetAccountResultOutput), nil
