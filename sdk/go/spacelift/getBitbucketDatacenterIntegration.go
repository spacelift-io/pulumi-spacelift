...
//			_, err := spacelift.GetBitbucketDatacenterIntegration(ctx, &spacelift.GetBitbucketDatacenterIntegrationArgs{}, nil)
//			if err != nil {
//				return err
//			}
//			return nil
...
func GetBitbucketDatacenterIntegrationOutput(ctx *pulumi.Context, args GetBitbucketDatacenterIntegrationOutputArgs, opts ...pulumi.InvokeOption) GetBitbucketDatacenterIntegrationResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetBitbucketDatacenterIntegrationResultOutput, error) {
			args := v.(GetBitbucketDatacenterIntegrationArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("spacelift:index/getBitbucketDatacenterIntegration:getBitbucketDatacenterIntegration", args, GetBitbucketDatacenterIntegrationResultOutput{}, options).(GetBitbucketDatacenterIntegrationResultOutput), nil
