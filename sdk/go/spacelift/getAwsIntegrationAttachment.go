...
func LookupAwsIntegrationAttachmentOutput(ctx *pulumi.Context, args LookupAwsIntegrationAttachmentOutputArgs, opts ...pulumi.InvokeOption) LookupAwsIntegrationAttachmentResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupAwsIntegrationAttachmentResultOutput, error) {
			args := v.(LookupAwsIntegrationAttachmentArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("spacelift:index/getAwsIntegrationAttachment:getAwsIntegrationAttachment", args, LookupAwsIntegrationAttachmentResultOutput{}, options).(LookupAwsIntegrationAttachmentResultOutput), nil
