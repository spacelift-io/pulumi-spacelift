...
func LookupAzureIntegrationAttachmentOutput(ctx *pulumi.Context, args LookupAzureIntegrationAttachmentOutputArgs, opts ...pulumi.InvokeOption) LookupAzureIntegrationAttachmentResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupAzureIntegrationAttachmentResultOutput, error) {
			args := v.(LookupAzureIntegrationAttachmentArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("spacelift:index/getAzureIntegrationAttachment:getAzureIntegrationAttachment", args, LookupAzureIntegrationAttachmentResultOutput{}, options).(LookupAzureIntegrationAttachmentResultOutput), nil
