...
func GetAwsIntegrationAttachmentExternalIdOutput(ctx *pulumi.Context, args GetAwsIntegrationAttachmentExternalIdOutputArgs, opts ...pulumi.InvokeOption) GetAwsIntegrationAttachmentExternalIdResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetAwsIntegrationAttachmentExternalIdResultOutput, error) {
			args := v.(GetAwsIntegrationAttachmentExternalIdArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("spacelift:index/getAwsIntegrationAttachmentExternalId:getAwsIntegrationAttachmentExternalId", args, GetAwsIntegrationAttachmentExternalIdResultOutput{}, options).(GetAwsIntegrationAttachmentExternalIdResultOutput), nil
