...
func LookupAzureIntegrationOutput(ctx *pulumi.Context, args LookupAzureIntegrationOutputArgs, opts ...pulumi.InvokeOption) LookupAzureIntegrationResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupAzureIntegrationResultOutput, error) {
			args := v.(LookupAzureIntegrationArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("spacelift:index/getAzureIntegration:getAzureIntegration", args, LookupAzureIntegrationResultOutput{}, options).(LookupAzureIntegrationResultOutput), nil
