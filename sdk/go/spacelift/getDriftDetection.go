...
func LookupDriftDetectionOutput(ctx *pulumi.Context, args LookupDriftDetectionOutputArgs, opts ...pulumi.InvokeOption) LookupDriftDetectionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupDriftDetectionResultOutput, error) {
			args := v.(LookupDriftDetectionArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("spacelift:index/getDriftDetection:getDriftDetection", args, LookupDriftDetectionResultOutput{}, options).(LookupDriftDetectionResultOutput), nil
