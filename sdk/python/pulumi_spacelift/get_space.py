...
def get_space(space_id: Optional[_builtins.str] = None,
    ...
    space = spacelift.get_space(space_id=space_spacelift_space["id"])
...
def get_space_output(space_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('spacelift:index/getSpace:getSpace', __args__, opts=opts, typ=GetSpaceResult)
