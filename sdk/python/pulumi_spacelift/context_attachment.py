...
class ContextAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] context_id: ID of the context to attach
        :param pulumi.Input[_builtins.str] module_id: ID of the module to attach the context to
        :param pulumi.Input[_builtins.int] priority: Priority of the context attachment. All the contexts attached to a stack are sorted by priority (lowest first), though values don't need to be unique. This ordering establishes precedence rules between contexts should there be a conflict and multiple contexts define the same value. Defaults to `0`.
        :param pulumi.Input[_builtins.str] stack_id: ID of the stack to attach the context to
        """
...
@pulumi.type_token("spacelift:index/contextAttachment:ContextAttachment")
class ContextAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            module_id: Optional[pulumi.Input[_builtins.str]] = None,
            priority: Optional[pulumi.Input[_builtins.int]] = None,
            stack_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'ContextAttachment':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="contextId")
    def context_id(self) -> pulumi.Output[_builtins.str]:
        """
        ID of the context to attach
        """
        return pulumi.get(self, "context_id")
