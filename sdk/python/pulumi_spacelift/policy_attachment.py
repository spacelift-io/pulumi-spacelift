...
class PolicyAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] policy_id: ID of the policy to attach
        :param pulumi.Input[_builtins.str] module_id: ID of the module to attach the policy to
        :param pulumi.Input[_builtins.str] stack_id: ID of the stack to attach the policy to
        """
...
@pulumi.type_token("spacelift:index/policyAttachment:PolicyAttachment")
class PolicyAttachment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        no_weekend_deploys = spacelift.Policy("no-weekend-deploys",
            name="Let's not deploy any changes over the weekend",
            body=std.file(input="policies/no-weekend-deploys.rego").result,
            type="PLAN")
        core_infra_production = spacelift.Stack("core-infra-production",
            name="Core Infrastructure (production)",
            branch="master",
            repository="core-infra")
        no_weekend_deploys_policy_attachment = spacelift.PolicyAttachment("no-weekend-deploys",
            policy_id=no_weekend_deploys.id,
    ...
    def get(resource_name: str,
            ...
            module_id: Optional[pulumi.Input[_builtins.str]] = None,
            policy_id: Optional[pulumi.Input[_builtins.str]] = None,
            stack_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'PolicyAttachment':
        """
