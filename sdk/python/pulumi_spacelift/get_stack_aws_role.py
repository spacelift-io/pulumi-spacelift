...
def get_stack_aws_role(module_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str module_id: ID of the module which assumes the AWS IAM role
    :param _builtins.str stack_id: ID of the stack which assumes the AWS IAM role
    """
    __args__ = dict()
...
def get_stack_aws_role_output(module_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                              stack_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                              opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetStackAwsRoleResult]:
    """
    > **Note:** `StackAwsRole` is deprecated. Please use `AwsRole` instead. The functionality is identical.
    ...
    __ret__ = pulumi.runtime.invoke_output('spacelift:index/getStackAwsRole:getStackAwsRole', __args__, opts=opts, typ=GetStackAwsRoleResult)
    return __ret__.apply(lambda __response__: GetStackAwsRoleResult(
