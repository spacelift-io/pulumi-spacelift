...
class VcsAgentPoolArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] description: Free-form VCS agent pool description for users
        :param pulumi.Input[_builtins.str] name: Name of the VCS agent pool, must be unique within an account
        """
...
class _VcsAgentPoolState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] config: VCS agent pool configuration, encoded using base64
        :param pulumi.Input[_builtins.str] description: Free-form VCS agent pool description for users
        :param pulumi.Input[_builtins.str] name: Name of the VCS agent pool, must be unique within an account
        """
...
@pulumi.type_token("spacelift:index/vcsAgentPool:VcsAgentPool")
class VcsAgentPool(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            config: Optional[pulumi.Input[_builtins.str]] = None,
            description: Optional[pulumi.Input[_builtins.str]] = None,
            name: Optional[pulumi.Input[_builtins.str]] = None) -> 'VcsAgentPool':
        """
