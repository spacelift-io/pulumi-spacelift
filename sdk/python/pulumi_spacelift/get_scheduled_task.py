...
class GetScheduledTaskResult:
    ...
    @_builtins.property
    @pulumi.getter
    def everies(self) -> Sequence[_builtins.str]:
        """
...
def get_scheduled_task(scheduled_task_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str scheduled_task_id: ID of the scheduled task (stack*id/schedule*id)
    """
    __args__ = dict()
...
def get_scheduled_task_output(scheduled_task_id: Optional[pulumi.Input[_builtins.str]] = None,
                              opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetScheduledTaskResult]:
    """
    `ScheduledTask` represents a scheduling configuration for a Stack. It will trigger a task on the given timestamp/schedule.
    ...
    __ret__ = pulumi.runtime.invoke_output('spacelift:index/getScheduledTask:getScheduledTask', __args__, opts=opts, typ=GetScheduledTaskResult)
    return __ret__.apply(lambda __response__: GetScheduledTaskResult(
        at=pulumi.get(__response__, 'at'),
        command=pulumi.get(__response__, 'command'),
        everies=pulumi.get(__response__, 'everies'),
