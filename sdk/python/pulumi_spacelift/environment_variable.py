...
class EnvironmentVariableArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] context_id: ID of the context on which the environment variable is defined
        :param pulumi.Input[_builtins.str] module_id: ID of the module on which the environment variable is defined
        :param pulumi.Input[_builtins.str] name: Name of the environment variable
        :param pulumi.Input[_builtins.str] stack_id: ID of the stack on which the environment variable is defined
        :param pulumi.Input[_builtins.str] value: Value of the environment variable. Defaults to an empty string.
        :param pulumi.Input[_builtins.bool] write_only: Indicates whether the value is secret or not. Defaults to `true`.
        """
...
@pulumi.type_token("spacelift:index/environmentVariable:EnvironmentVariable")
class EnvironmentVariable(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            stack_id: Optional[pulumi.Input[_builtins.str]] = None,
            value: Optional[pulumi.Input[_builtins.str]] = None,
            write_only: Optional[pulumi.Input[_builtins.bool]] = None) -> 'EnvironmentVariable':
        """
