...
def get_bitbucket_cloud_integration(id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str id: Bitbucket Cloud integration id. If not provided, the default integration will be returned
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_bitbucket_cloud_integration_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                           opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetBitbucketCloudIntegrationResult]:
    """
    `get_bitbucket_cloud_integration` returns details about Bitbucket Cloud integration
    ...
    __ret__ = pulumi.runtime.invoke_output('spacelift:index/getBitbucketCloudIntegration:getBitbucketCloudIntegration', __args__, opts=opts, typ=GetBitbucketCloudIntegrationResult)
    return __ret__.apply(lambda __response__: GetBitbucketCloudIntegrationResult(
