...
class StackDestructorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] stack_id: ID of the stack to delete and destroy on destruction
        :param pulumi.Input[_builtins.bool] deactivated: If set to true, destruction won't delete the stack
        """
...
@pulumi.type_token("spacelift:index/stackDestructor:StackDestructor")
class StackDestructor(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        k8s_core_stack_destructor = spacelift.StackDestructor("k8s-core", stack_id=k8s_core.id,
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            deactivated: Optional[pulumi.Input[_builtins.bool]] = None,
            stack_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'StackDestructor':
        """
