...
class NamedWebhookSecretHeaderArgs:
    def __init__(__self__, *,
                 ...
                 webhook_id: pulumi.Input[_builtins.str]):
        """
        The set of arguments for constructing a NamedWebhookSecretHeader resource.

        :param pulumi.Input[_builtins.str] key: key for the header
        :param pulumi.Input[_builtins.str] value: value for the header
        :param pulumi.Input[_builtins.str] webhook_id: ID of the stack on which the environment variable is defined
        """
    ...
    def webhook_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @webhook_id.setter
    def webhook_id(self, value: pulumi.Input[_builtins.str]):
...
@pulumi.type_token("spacelift:index/namedWebhookSecretHeader:NamedWebhookSecretHeader")
class NamedWebhookSecretHeader(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            key: Optional[pulumi.Input[_builtins.str]] = None,
            value: Optional[pulumi.Input[_builtins.str]] = None,
            webhook_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'NamedWebhookSecretHeader':
        """
