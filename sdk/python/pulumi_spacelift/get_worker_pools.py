...
def get_worker_pools_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetWorkerPoolsResult]:
    """
    `get_worker_pools` represents the worker pools assigned to the Spacelift account.
    ...
    __ret__ = pulumi.runtime.invoke_output('spacelift:index/getWorkerPools:getWorkerPools', __args__, opts=opts, typ=GetWorkerPoolsResult)
    return __ret__.apply(lambda __response__: GetWorkerPoolsResult(
