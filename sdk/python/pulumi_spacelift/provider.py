...
class ProviderArgs:
    def __init__(__self__, *,
        ...
        ProviderArgs._configure(
            ...
            api_key_endpoint=api_key_endpoint,
    ...
    def _configure(
             ...
             **kwargs):
        if api_key_endpoint is None and 'apiKeyEndpoint' in kwargs:
            api_key_endpoint = kwargs['apiKeyEndpoint']
        if api_key_id is None and 'apiKeyId' in kwargs:
            api_key_id = kwargs['apiKeyId']
        if api_key_secret is None and 'apiKeySecret' in kwargs:
            api_key_secret = kwargs['apiKeySecret']
        ...
        if api_key_endpoint is not None:
            _setter("api_key_endpoint", api_key_endpoint)
        ...
        if api_key_secret is not None:
            _setter("api_key_secret", api_key_secret)
