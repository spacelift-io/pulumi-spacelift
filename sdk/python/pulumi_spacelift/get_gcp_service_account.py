...
def get_gcp_service_account(module_id: Optional[_builtins.str] = None,
...
def get_gcp_service_account_output(module_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                   stack_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                   opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetGcpServiceAccountResult]:
    """
    `GcpServiceAccount` represents a Google Cloud Platform service account that's linked to a particular Stack or Module. These accounts are created by Spacelift on per-stack basis, and can be added as members to as many organizations and projects as needed. During a Run or a Task, temporary credentials for those service accounts are injected into the environment, which allows credential-less GCP Terraform provider setup.
    ...
    __ret__ = pulumi.runtime.invoke_output('spacelift:index/getGcpServiceAccount:getGcpServiceAccount', __args__, opts=opts, typ=GetGcpServiceAccountResult)
    return __ret__.apply(lambda __response__: GetGcpServiceAccountResult(
