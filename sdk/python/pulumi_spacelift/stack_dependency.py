...
class StackDependencyArgs:
    def __init__(__self__, *,
                 depends_on_stack_id: pulumi.Input[_builtins.str],
                 stack_id: pulumi.Input[_builtins.str]):
        """
        The set of arguments for constructing a StackDependency resource.

        :param pulumi.Input[_builtins.str] depends_on_stack_id: immutable ID (slug) of stack to depend on.
        :param pulumi.Input[_builtins.str] stack_id: immutable ID (slug) of stack which has a dependency.
        """
    ...
    def depends_on_stack_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def depends_on_stack_id(self, value: pulumi.Input[_builtins.str]):
...
class _StackDependencyState:
    def __init__(__self__, *,
                 depends_on_stack_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="dependsOnStackId")
    def depends_on_stack_id(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        immutable ID (slug) of stack to depend on.
        """
        return pulumi.get(self, "depends_on_stack_id")
    ...
    @depends_on_stack_id.setter
    def depends_on_stack_id(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "depends_on_stack_id", value)
...
@pulumi.type_token("spacelift:index/stackDependency:StackDependency")
class StackDependency(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            depends_on_stack_id: Optional[pulumi.Input[_builtins.str]] = None,
            stack_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'StackDependency':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="dependsOnStackId")
    def depends_on_stack_id(self) -> pulumi.Output[_builtins.str]:
        """
        immutable ID (slug) of stack to depend on.
        """
        return pulumi.get(self, "depends_on_stack_id")
