...
def get_webhook(module_id: Optional[_builtins.str] = None,
    ...
    webhook = spacelift.get_webhook(webhook_id=webhook_spacelift_webhook["id"])
    ```


    :param _builtins.str module_id: ID of the stack which triggers the webhooks
    :param _builtins.str stack_id: ID of the stack which triggers the webhooks
...
def get_webhook_output(module_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('spacelift:index/getWebhook:getWebhook', __args__, opts=opts, typ=GetWebhookResult)
