...
def get_aws_integration_attachment(integration_id: Optional[str] = None,
...
def get_aws_integration_attachment_output(integration_id: Optional[pulumi.Input[str]] = None,
                                          module_id: Optional[pulumi.Input[Optional[str]]] = None,
                                          stack_id: Optional[pulumi.Input[Optional[str]]] = None,
                                          opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetAwsIntegrationAttachmentResult]:
    """
    `AwsIntegrationAttachment` represents the attachment between a reusable AWS integration and a single stack or module.
