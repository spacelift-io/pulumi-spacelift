...
def get_worker_pool(worker_pool_id: Optional[_builtins.str] = None,
...
def get_worker_pool_output(worker_pool_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('spacelift:index/getWorkerPool:getWorkerPool', __args__, opts=opts, typ=GetWorkerPoolResult)
