...
def get_azure_integration(integration_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: The friendly name of the integration. Either `integration_id` or `name` must be specified.
    """
    __args__ = dict()
...
def get_azure_integration_output(integration_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                 name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                 opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetAzureIntegrationResult]:
    """
    `AzureIntegration` represents an integration with an Azure AD tenant. This integration is account-level and needs to be explicitly attached to individual stacks in order to take effect. Note that you will need to provide admin consent manually for the integration to work
    ...
    __ret__ = pulumi.runtime.invoke_output('spacelift:index/getAzureIntegration:getAzureIntegration', __args__, opts=opts, typ=GetAzureIntegrationResult)
    return __ret__.apply(lambda __response__: GetAzureIntegrationResult(
        admin_consent_provided=pulumi.get(__response__, 'admin_consent_provided'),
        admin_consent_url=pulumi.get(__response__, 'admin_consent_url'),
        application_id=pulumi.get(__response__, 'application_id'),
        default_subscription_id=pulumi.get(__response__, 'default_subscription_id'),
