...
def get_context_attachment(context_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str context_id: ID of the attached context
    :param _builtins.str module_id: ID of the attached module
    :param _builtins.str stack_id: ID of the attached stack
    """
    __args__ = dict()
...
def get_context_attachment_output(context_id: Optional[pulumi.Input[_builtins.str]] = None,
                                  module_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                  stack_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                  opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetContextAttachmentResult]:
    """
    `ContextAttachment` represents a Spacelift attachment of a single context to a single stack or module, with a predefined priority.
    ...
    __ret__ = pulumi.runtime.invoke_output('spacelift:index/getContextAttachment:getContextAttachment', __args__, opts=opts, typ=GetContextAttachmentResult)
    return __ret__.apply(lambda __response__: GetContextAttachmentResult(
