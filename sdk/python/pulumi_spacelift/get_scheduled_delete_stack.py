...
class GetScheduledDeleteStackResult:
    ...
    def delete_resources(self) -> _builtins.bool:
        """
    ...
    def scheduled_delete_stack_id(self) -> _builtins.str:
        """
...
def get_scheduled_delete_stack(scheduled_delete_stack_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str scheduled_delete_stack_id: ID of the scheduled delete*stack (stack*id/schedule_id)
    """
    __args__ = dict()
...
def get_scheduled_delete_stack_output(scheduled_delete_stack_id: Optional[pulumi.Input[_builtins.str]] = None,
                                      opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetScheduledDeleteStackResult]:
    """
    `ScheduledDeleteTask` represents a scheduling configuration for a Stack. It will trigger a stack deletion task at the given timestamp.
    ...
    __ret__ = pulumi.runtime.invoke_output('spacelift:index/getScheduledDeleteStack:getScheduledDeleteStack', __args__, opts=opts, typ=GetScheduledDeleteStackResult)
    return __ret__.apply(lambda __response__: GetScheduledDeleteStackResult(
        at=pulumi.get(__response__, 'at'),
        delete_resources=pulumi.get(__response__, 'delete_resources'),
        id=pulumi.get(__response__, 'id'),
        schedule_id=pulumi.get(__response__, 'schedule_id'),
        scheduled_delete_stack_id=pulumi.get(__response__, 'scheduled_delete_stack_id'),
