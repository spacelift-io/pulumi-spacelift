...
class VersionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] module_id: ID of the module on which the version creation is to be triggered.
        :param pulumi.Input[_builtins.str] commit_sha: The commit SHA for which to trigger a version.
        ...
        :param pulumi.Input[_builtins.str] version_number: A semantic version number to set for the triggered version, example: 0.11.2
        """
...
@pulumi.type_token("spacelift:index/version:Version")
class Version(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            keepers: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            module_id: Optional[pulumi.Input[_builtins.str]] = None,
            version_number: Optional[pulumi.Input[_builtins.str]] = None) -> 'Version':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="versionNumber")
    def version_number(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        A semantic version number to set for the triggered version, example: 0.11.2
        """
        return pulumi.get(self, "version_number")
