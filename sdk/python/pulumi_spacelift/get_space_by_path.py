...
class GetSpaceByPathResult:
    ...
    def space_path(self) -> _builtins.str:
        """
...
def get_space_by_path(space_path: Optional[_builtins.str] = None,
    ...
    **Disclaimer:**
    ...
    :param _builtins.str space_path: path to the space - a series of space names separated by `/`
    """
    __args__ = dict()
...
def get_space_by_path_output(space_path: Optional[pulumi.Input[_builtins.str]] = None,
                             opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetSpaceByPathResult]:
    """
    `get_space_by_path` represents a Spacelift **space** - a collection of resources such as stacks, modules, policies, etc. Allows for more granular access control. Can have a parent space. In contrary to `Space`, this resource is identified by a path, not by an ID. For this data source to work, path must be unique. If there are multiple spaces with the same path, this datasource will fail.
    **Disclaimer:**
    This datasource can only be used in a stack that resides in a space with inheritance enabled. In addition, the parent spaces (excluding root) must also have inheritance enabled.
    ...
    __ret__ = pulumi.runtime.invoke_output('spacelift:index/getSpaceByPath:getSpaceByPath', __args__, opts=opts, typ=GetSpaceByPathResult)
    return __ret__.apply(lambda __response__: GetSpaceByPathResult(
        description=pulumi.get(__response__, 'description'),
        id=pulumi.get(__response__, 'id'),
        inherit_entities=pulumi.get(__response__, 'inherit_entities'),
        labels=pulumi.get(__response__, 'labels'),
        name=pulumi.get(__response__, 'name'),
        parent_space_id=pulumi.get(__response__, 'parent_space_id'),
        space_path=pulumi.get(__response__, 'space_path')))
