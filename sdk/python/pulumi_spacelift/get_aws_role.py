...
def get_aws_role(module_id: Optional[_builtins.str] = None,
...
def get_aws_role_output(module_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                        stack_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetAwsRoleResult]:
    """
    `AwsRole` represents [cross-account IAM role delegation](https://docs.aws.amazon.com/IAM/latest/UserGuide/tutorial_cross-account-with-roles.html) between the Spacelift worker and an individual stack or module. If this is set, Spacelift will use AWS STS to assume the supplied IAM role and put its temporary credentials in the runtime environment.
    ...
    __ret__ = pulumi.runtime.invoke_output('spacelift:index/getAwsRole:getAwsRole', __args__, opts=opts, typ=GetAwsRoleResult)
    return __ret__.apply(lambda __response__: GetAwsRoleResult(
