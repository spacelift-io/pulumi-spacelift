...
def get_github_enterprise_integration(id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str id: Github integration id. If not provided, the default integration will be returned
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_github_enterprise_integration_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                             opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetGithubEnterpriseIntegrationResult]:
    """
    `get_github_enterprise_integration` returns details about Github Enterprise integration
    ...
    __ret__ = pulumi.runtime.invoke_output('spacelift:index/getGithubEnterpriseIntegration:getGithubEnterpriseIntegration', __args__, opts=opts, typ=GetGithubEnterpriseIntegrationResult)
    return __ret__.apply(lambda __response__: GetGithubEnterpriseIntegrationResult(
